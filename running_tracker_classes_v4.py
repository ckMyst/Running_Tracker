...
class selectProf:
    def __init__(self, master):
        ...
        self.profBtn1 = tk.Button(master, text="New User", command=self.topWin1)
        self.profBtn1.grid()
        self.profBtn2 = tk.Button(master, text="Existing User", command=self.topWin1)
        self.profBtn2.grid()
# ==============================================
    def __init__(self, master):
        self.commence = master
        self.commence.withdraw()
        self.topWin1 = tk.Toplevel(self.commence)
        self.topWin1.geometry("350x400")
        newWin1 = infoWin(self.topWin1)
# ==============================================
class dataEntry:
    def __init__(self, master):
        self.commence = master
